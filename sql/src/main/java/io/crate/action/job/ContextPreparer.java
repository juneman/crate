        ...
        public Boolean visitPrimaryKeyLookupPhase(final PrimaryKeyLookupPhase phase, final PreparerContext context) {
            ...
            if (indexShardMap == null) {
                throw new IllegalArgumentException(
                        "The routing of the primaryKeyLookupPhase doesn't contain the current nodeId. locations=" + locations + ", localNode=" + localNodeId);
            }
            ...
            context.registerSubContext(new PrimaryKeyLookupContext(
                ...
                indexShardMap,
                phase.docKeys(),
                phase.docKeysByShard(clusterService),
                phase.tableIdent(),
                phase.toCollect()
            ));
            return true;
